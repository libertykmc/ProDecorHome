    ...
    <>
      {token ? (
        <div className={styles.userPage}>
          ...
          <h3 className={styles.profilemail}>Ваш логин: {user?.login}</h3>
          ...
          <div className={styles.profilsettings}>
            ...
            >
              <div className={styles.profilInputDiv}>
                <label className={styles.profilInputLabel}>Имя:</label>
                <input
                  type="text"
              ...
              <div className={styles.profilInputDiv}>
                <label className={styles.profilInputLabel}>Фамилия:</label>
                <input
                  type="text"
                  className={styles.profilInput}
              ...
              <div className={styles.profilInputDiv}>
                <label className={styles.profilInputLabel}>Отчество:</label>
                <input
                  type="text"
                  className={styles.profilInput}
              ...
              <div className={styles.profilInputDiv}>
                <label className={styles.profilInputLabel}>Телефон:</label>
                <input
                  type="phone"
                  className={styles.profilInput}
                  ...
                  onChange={(event) => {
                    ...
                    setValidateNumber(isValidPhone(event.target.value));
                  }}
                />
              </div>

              <button className={styles.profilesave}>Сохранить</button>
              <button className={styles.profilesave} onClick={logout}>
                Выйти
              </button>
              {success ? <div>Данные успешно изменены</div> : <div></div>}
            </form>
          </div>
